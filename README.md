...
```bash
git clone https://github.com/tomalhossencse/community-cleanliness-client.git
...
Project Link: [community-cleanliness-client](https://github.com/tomalhossencse/community-cleanliness-client)
